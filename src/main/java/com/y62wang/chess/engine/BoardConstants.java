...
public class BoardConstants
{
    ...
    public static final long W_KING_CASTLE_ATTACK_MASK = BoardUtil.position(SQ_F1, SQ_G1);
    public static final long W_QUEEN_CASTLE_ATTACK_MASK = BoardUtil.position(SQ_C1, SQ_D1);
    public static final long B_KING_CASTLE_ATTACK_MASK = BoardUtil.position(SQ_F8, SQ_G8);
    public static final long B_QUEEN_CASTLE_ATTACK_MASK = BoardUtil.position(SQ_C8, SQ_D8);

    public static final long W_KING_CASTLE_CLEAR_MASK = BoardUtil.position(SQ_F1, SQ_G1);
    public static final long W_QUEEN_CASTLE_CLEAR_MASK = BoardUtil.position(SQ_B1, SQ_C1, SQ_D1);
    public static final long B_KING_CASTLE_CLEAR_MASK = BoardUtil.position(SQ_F8, SQ_G8);
    public static final long B_QUEEN_CASTLE_CLEAR_MASK = BoardUtil.position(SQ_B8, SQ_C8, SQ_D8);
